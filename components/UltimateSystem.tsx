...
export default function UltimateSystem() {
  return (
    <section className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          The 6.6kW Ultimate Package will save you anywhere between $890 to $1,917 per year off your electricity bill, depending on your location and Electricity consumption. Maximise your opportunity and savings. Suitable for households spending up to $1000 or more per year.
          </p>
          ...
          <div className="border-2 border-gray-300 p-6 bg-white hover:border-[#FFD700] transition-all duration-300 hover:shadow-lg">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  CEC Approved Double Tracker 5kw Wifi Inverter ( top 5 listed in worldwide ranking )
                </p>
              </div>
