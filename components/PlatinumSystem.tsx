...
export default function PlatinumSystem() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed max-w-5xl mx-auto mb-6">
            The USE is partnered with Fronius which is an Austrian based company to supply and install inverters across Australia. The Effiux Boost Package will save 
            you anywhere between $890 to $1,897 per year off your electricity bill, depending on your location and Electricity consumption. Maximise your 
            opportunity and savings. Suitable for households spending up to $1600 or more per year.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="border-2 border-gray-300 p-6 bg-white hover:border-[#FFD700] transition-all duration-300 hover:shadow-lg">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  Approximate Annual Output Between 8900kwh - 9400kwh
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  CEC Approved Tier 1 =440v Solar Panels N-type Bifacial Double Glass High Efficiency Mono Module
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Worth up to 7yd kw/peak grid and 15.5 rated (Rebate-able Tier 1 Brand)
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  EUTPSS Australia 2019 Value for Money Winner
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  CEC Approved Double Tracker 5kw 6kW Inverter | top 5 listed in Australia
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Australian top listed inverter shield ( TMADD in Austria )
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Aluminium and Stainless Steel Mounting kit ( Approved By Clean )
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2"></div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Optional Raised Frame and Panels to Withstand High Loads
                </p>
              </div>
            ...
            <div className="mt-6 text-center text-gray-700 text-xs leading-relaxed">
              At Ultimate Solar Energy We Make Sure Our Work to Be In Accordance With Australian Standards & Clean Energy Council 
              Accredited Installers To Install Premium Quality Products, get obligation free customise quote for your home to know more about 
              this package.
            </div>
          </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="border-2 border-gray-300 p-6 bg-white hover:border-[#FFD700] transition-all duration-300 hover:shadow-lg">
              ...
              <div className="flex justify-around items-center mb-6 divide-x divide-gray-300">
                ...
                <div className="text-center flex-1 px-4">
                  ...
                  <p className="text-gray-700 font-semibold text-sm">
                    Panels<br/>
                    ISV 440 n-type Bifacial Double<br/>
            ...
            <div className="border-2 border-gray-300 p-6 bg-white hover:border-[#FFD700] transition-all duration-300 hover:shadow-lg">
              ...
              <div className="text-center">
                <Link 
                  href="/products/6-6-kw-boost-system"
                  className="inline-block bg-[#FFD700] text-[#002866] font-bold py-2 px-6 text-sm uppercase tracking-wide shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group"
                >
                  <span className="relative z-10">FIND OUT MORE</span>
                  <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out"></span>
