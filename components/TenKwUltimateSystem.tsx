...
export default function TenKwUltimateSystem() {
  return (
    <section className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          The 10kW Ultimate Package will save you anywhere between $2000 to $3900 per year off your electricity bill, depending on your location and Electricity consumption. Maximise your opportunity and savings. Suitable for households spending up to $1600 or more per year.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  Approximate Annual Output Between 13600 kwh – 14800kwh
                </p>
              </div>
          ...
          <div className="border-2 border-gray-300 p-6 bg-white hover:border-[#FFD700] transition-all duration-300 hover:shadow-lg">
            ...
            <div className="text-gray-700 text-sm leading-relaxed mb-6">
              <p className="mb-4">
                Ultimate Solar Energy's quality assurance team choose one of the best available products in the market at given time. None of our products' warranties are backed by locally and our supply partners have their official technical in major cities around Australia.
              </p>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="border-2 border-gray-300 p-6 bg-white hover:border-[#FFD700] transition-all duration-300 hover:shadow-lg">
              ...
              <div className="flex justify-around items-center mb-6 divide-x divide-gray-300">
                <div className="text-center flex-1 px-4">
                  ...
                  <p className="text-gray-700 font-semibold text-sm">
                    Inverter<br/>
                    8Kw Fronius Primo Gen24/ 8Kw<br/>
                    SMA
                  </p>
                </div>
                ...
                <div className="text-center flex-1 px-4">
                  ...
                  <p className="text-gray-700 font-semibold text-sm">
                    Panels<br/>
                    24X 440 n-type Bifacial Double<br/>
              ...
              <div className="text-center">
                <Link 
                  href="/products/10-5-kw-platinum-system"
