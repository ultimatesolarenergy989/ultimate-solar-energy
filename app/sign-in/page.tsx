          ...
          <div className="px-8 py-10">
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#002866] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                  </svg>
                  <div>
                    <p className="text-sm font-semibold text-[#002866] mb-1">Authorized Users Only</p>
                    <p className="text-sm text-gray-700">This login is restricted to authorized personnel. If you need access, please contact the administrator at  
                      <a href="mailto:info@ultimatesolarenergy.com.au" className="font-semibold text-[#002866] hover:text-[#FDB714] transition-colors">info@ultimatesolarenergy.com.au</a>
                    </p>
                  </div>
              </div>
            </div>
