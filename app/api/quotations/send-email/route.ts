...
export async function POST(request: NextRequest) {
  try {
    ...
    const { quotationId, subject, message } = body;

    if (!quotationId || !subject || !message) {
        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <p>Hi ${quotation.firstName || quotation.lastName ? `${quotation.firstName ?? ""} ${quotation.lastName ?? ""}`.trim() : "there"},</p>
                <p>${message.replace(/\n/g, "<br/>")}</p>
              </div>
              <div class="footer">
