                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-800 leading-relaxed">
                          <span className="font-semibold">37X 550 Watt Panels High Performing Advance Technology Half Cell Module (Tier 1)</span>
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-1" />
                ...
                <div className="p-6 md:p-8">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                    <div className="flex-1 space-y-4">
                      <div className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-1" />
                        <p className="text-gray-800 leading-relaxed">1X 15KW Sungrow / 15KW Fimer</p>
                      </div>
                      <div className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-1" />
                      ...
                      <div className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-1" />
                        <p className="text-gray-800 leading-relaxed">Online monitoringy</p>
                      </div>
                      <div className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-1" />
